...
/**
 * BlogLayout1 - Default 2-column detailed blog layout with sticky Table of Contents,
 * visual header overview banner, author attribution, and related articles grid.
 */
export function BlogLayout1({ post, relatedPosts }: BlogLayoutProps) {
  return (
    <>
        ...
        <Container>
          ...
          <nav aria-label="Breadcrumb" className="mb-6">
            <ol className="flex flex-wrap items-center gap-2 text-xs font-medium text-slate">
              ...
              <li
                className="font-semibold text-ink truncate max-w-[200px] md:max-w-xs"
                aria-current="page"
              >
                {post.title}
              </li>
            ...
            <div className="mt-6 flex flex-wrap items-center justify-between gap-4 border-y border-slate/10 py-4">
              ...
              <div className="flex items-center gap-4 text-xs text-slate">
                <div className="flex items-center gap-1.5">
                  ...
                  <span>Updated: {post.lastUpdated || post.publishedDate}</span>
                </div>
              </div>
            </div>
          </div>
