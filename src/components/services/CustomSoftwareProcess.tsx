      ...
      <Container>
        ...
        <div className="mt-16 space-y-6">
          {process.stages.map((stage) => (
            ...
            >
              {/* Step Number Badge */}
              <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-interactive-blue font-extrabold text-white text-xl shadow-md shadow-interactive-blue/20">
                {stage.step}
              </div>
