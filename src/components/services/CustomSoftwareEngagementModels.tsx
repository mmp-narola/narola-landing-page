          ...
          {engagementModels.map((item, idx) => {
            ...
            return (
              <button
                key={item.id}
                type="button"
                className={`rounded-2xl px-6 py-3 text-xs font-medium transition-all sm:text-sm ${
                  isSelected
            ...
            <div className="lg:col-span-7">
              ...
              <div className="mt-8">
                <a
                  ...
                  className="inline-flex items-center justify-center rounded-xl bg-interactive-blue px-6 py-3.5 text-sm font-medium text-white shadow-md shadow-interactive-blue/20 transition-all hover:bg-interactive-blue/90"
                >
                  {model.ctaText} →
                </a>
              </div>
