...
export function MegaMenuPanel({ menu, onNavigate }: MegaMenuPanelProps) {
  ...
  return (
    <div className="w-full max-w-[1240px] rounded-2xl border border-black/[0.08] bg-white mt-0.5 p-7 text-light-gray shadow-[0_25px_80px_-15px_rgba(0,0,0,0.22)] lg:p-9">
                ...
                {column.groups ? (
                  column.groups.map((group) => (
                    <div key={group.heading} className="flex flex-col">
                      <h4 className="text-sm font-semibold text-light-gray sm:text-[15px]">
                        {group.heading}
                      </h4>
