...
[
  {
    ...
    practiceAreas: ["product-engineering", "ai-automation"],
    serviceTypes: ["mobile", "saas", "mvp", "workflow"],
    industryCategories: ["Sports & Entertainment", "Enterprise", "SaaS", "Education"],
  ...
  },
  {
    ...
    practiceAreas: ["product-engineering", "ai-automation"],
    serviceTypes: ["web", "enterprise", "workflow", "consulting"],
    industryCategories: ["Automotive & Industrial", "Enterprise", "Logistics"],
    regions: ["Europe", "UK"],
  ...
  },
  {
    ...
    practiceAreas: ["ecommerce", "product-engineering"],
    serviceTypes: ["b2b", "custom", "ai-commerce", "marketplace", "web"],
    industryCategories: ["Healthcare", "Healthcare & Ecommerce", "Enterprise", "Retail"],
    regions: ["USA", "North America"],
  ...
  },
  {
    ...
    region: "North America",
    practiceAreas: ["product-engineering", "ai-automation"],
    serviceTypes: ["web", "saas", "enterprise", "workflow", "document-processing"],
    industryCategories: ["Real Estate", "Enterprise", "SaaS"],
    regions: ["USA", "North America"],
  ...
  },
  {
    ...
    region: "North America",
    practiceAreas: ["ecommerce", "ai-automation"],
    serviceTypes: ["ai-commerce", "marketplace", "automation", "agents", "chatbots", "conversational"],
    industryCategories: ["Retail & Ecommerce", "Fashion", "Grocery", "Jewelry", "Retail"],
    regions: ["USA", "North America"],
  ...
  },
  {
    ...
    region: "North America",
    practiceAreas: ["ecommerce", "product-engineering"],
    serviceTypes: ["shopify", "headless", "b2b", "custom", "web", "saas", "crm-sales"],
    industryCategories: ["Life Style & Health", "Healthcare", "Grocery", "Retail"],
    regions: ["USA", "North America"],
